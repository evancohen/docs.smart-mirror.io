...
Once you've restarted, you can test these values using `printenv` to display all environmental variables on your Pi. If your keys do not appear ensure you have not place quotes around the keys when adding themto the ```~/.profile```
